...
module.exports = {
  ...
  getAllTagNameCompletions: function() {
    return this.completions.tags.map(tag => {
      return {
        text: tag,
        type: 'tag',
        description: tag,
  ...
  getTagNameCompletions: function({ prefix } = {}) {
    return this.completions.tags.reduce((result, tag) => {
  ...
  getAllAttributeNameCompletions: function({ editor, bufferPosition } = {}) {
    ...
    const { properties = {} } = this.completions.tags[tag] || {};
  ...
  getAttributeValueCompletion: function({ editor, bufferPosition, prefix } = {}) {
    ...
    const {
      properties: { [attribute]: { value, type } = {} } = {}
    } = this.completions.tags[tag] || {};
  ...
  loadCompletions: function() {
    ...
    const manifestPath = path.resolve(folder, 'node_modules/ecosoft-lexema8/lib/controls.manifest.json');
