...
module.exports = {
  activate() {
    ...
    try {
      manifestPath = path.resolve(folderPath, 'node_modules/ecosoft-lexema8/lib/controls.manifest.json');
    }
    catch(e) {
      atom.notifications.addError('Не удалось получить файл манифеста контролов');
    }
